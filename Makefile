lib/proto/cast_channel.desc: lib/proto/cast_channel.proto
...
proto: lib/proto/cast_channel.desc

tls: private-key.pem public-cert.pem

clean:
	rm lib/proto/cast_channel.desc private-key.pem csr.pem public-cert.pem
